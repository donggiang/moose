...

{
  ...
  // std::string model_path = "/Users/huyngd/projects/moose_neml2/modules/solid_mechanics/test/tests/"
...
ADMixtureOfExpertsElastoViscoplasticStress2::computeQpStress()
{
  ...
  if (effective_trial_stress > (1.0 + tolerance)) {
    ...
    MetaPhysicL::raw_value(_rhoc_old_temp), MetaPhysicL::raw_value(_rhow_old_temp), MetaPhysicL::raw_value(_flux[_qp])}}, torch::kFloat);
...
ADMixtureOfExpertsElastoViscoplasticStress2::eval(const torch::Tensor& tensor){
  ...
  auto varx1 = ADMixtureOfExpertsElastoViscoplasticStress2::minmax_transform(tensor.index({0, 0}), -1.0, 1.0, 0.11428862639259419753390289997697, 299.94931150862146296276478096842766);
  auto varx2 = ADMixtureOfExpertsElastoViscoplasticStress2::minmax_transform(tensor.index({0, 1}), -1.0, 1.0, 600.04429302445396388066001236438751, 1099.98408980407225499220658093690872);
  auto varx3 = ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_transform(tensor.index({0, 2}), -1.0, 1.0, -39.15241605429763183110480895265937, -3.91206356603903770974284270778298, 1e-20);
  auto varx4 = ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_transform(tensor.index({0, 3}), -1.0, 1.0, 12.56521587815730534032354626106098, 29.64417981061014728538793860934675, 0.0);
  auto varx5 = ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_transform(tensor.index({0, 4}), -1.0, 1.0, 29.12196678204971789227784029208124, 30.11574121515777946456182689871639, 0.0);
  auto varx6 = ADMixtureOfExpertsElastoViscoplasticStress2::minmax_transform(tensor.index({0, 5}), -1.0, 1.0, 0.0, 1.0);
  ...
  auto out1 = ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_inverse_transform(output.index({0, 0}), 0.0, 1.0, -30.54946341410551013950680498965085, 7.72739242062932873977842973545194, 0.0);
  auto out2 = ADMixtureOfExpertsElastoViscoplasticStress2::symlog_inverse_transform(output.index({0, 1}), -36.71520922998040958873389172367752, 38.45450753607088500984900747425854);
  auto out3 = ADMixtureOfExpertsElastoViscoplasticStress2::symlog_inverse_transform(output.index({0, 2}), -40.36444506932617315442257677204907, 35.04333232507948281408971524797380);
...
ADMixtureOfExpertsElastoViscoplasticStress2::eval_jacobian(const torch::Tensor& tensor){
  auto jax1 = ADMixtureOfExpertsElastoViscoplasticStress2::minmax_forward_derivative(tensor.index({0, 0}), -1.0, 1.0, 0.11428862639259419753390289997697, 299.94931150862146296276478096842766);
  auto jax2 = ADMixtureOfExpertsElastoViscoplasticStress2::minmax_forward_derivative(tensor.index({0, 1}), -1.0, 1.0, 600.04429302445396388066001236438751, 1099.98408980407225499220658093690872);
  auto jax3 = ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_forward_derivative(tensor.index({0, 2}), -1.0, 1.0, -39.15241605429763183110480895265937, -3.91206356603903770974284270778298, 1e-20);
  auto jax4 = ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_forward_derivative(tensor.index({0, 3}), -1.0, 1.0, 12.56521587815730534032354626106098, 29.64417981061014728538793860934675, 0.0);
  auto jax5 = ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_forward_derivative(tensor.index({0, 4}), -1.0, 1.0, 29.12196678204971789227784029208124, 30.11574121515777946456182689871639, 0.0);
  auto jax6 = ADMixtureOfExpertsElastoViscoplasticStress2::minmax_forward_derivative(tensor.index({0, 5}), -1.0, 1.0, 0.0, 1.0);
  ...
  auto out1 = ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_inverse_derivative(phi.index({0, 0}), 0.0, 1.0, -30.54946341410551013950680498965085, 7.72739242062932873977842973545194, 0.0);
  auto out2 = ADMixtureOfExpertsElastoViscoplasticStress2::symlog_inverse_derivative(phi.index({0, 1}), -36.71520922998040958873389172367752, 38.45450753607088500984900747425854);
  auto out3 = ADMixtureOfExpertsElastoViscoplasticStress2::symlog_inverse_derivative(phi.index({0, 2}), -40.36444506932617315442257677204907, 35.04333232507948281408971524797380);
...
torch::Tensor 
ADMixtureOfExpertsElastoViscoplasticStress2::minmax_transform(const torch::Tensor& x, double lb, double ub, double xmin, double xmax){
...
torch::Tensor 
ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_transform(const torch::Tensor& x, double lb, double ub, double logxmin, double logxmax, double eps){
  auto a = ub - lb;
  auto b = lb;
...
torch::Tensor 
ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_inverse_transform(const torch::Tensor& z, double lb, double ub, double logxmin, double logxmax, double eps){
  auto a = ub - lb;
  auto b = lb;
...
torch::Tensor 
ADMixtureOfExpertsElastoViscoplasticStress2::symlog_inverse_transform(const torch::Tensor& z_scaled, double zmin, double zmax){
...
torch::Tensor 
ADMixtureOfExpertsElastoViscoplasticStress2::minmax_forward_derivative(const torch::Tensor& x, double lb, double ub, double xmin, double xmax){
  auto a = ub - lb;
  // auto b = lb;
...
torch::Tensor 
ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_forward_derivative(const torch::Tensor& x, double lb, double ub, double logxmin, double logxmax, double eps){
  auto a = ub - lb;
  auto b = lb;
...
torch::Tensor 
ADMixtureOfExpertsElastoViscoplasticStress2::logtransform_inverse_derivative(const torch::Tensor& z, double lb, double ub, double logxmin, double logxmax, double eps){
  auto a = ub - lb;
  auto b = lb;
...
torch::Tensor 
ADMixtureOfExpertsElastoViscoplasticStress2::symlog_inverse_derivative(const torch::Tensor& z_scaled, double zmin, double zmax){
  auto z = (z_scaled + 1) * (zmax - zmin) / 2 + zmin;
