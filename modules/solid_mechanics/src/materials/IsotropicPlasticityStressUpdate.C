    ...
    const GenericReal<is_ad> & /*effective_trial_stress*/, const GenericReal<is_ad> & scalar)
{
  ...
  return -_hardening_constant +
         _saturate_coefficient * (_ultimate_strength - _yield_stress) *
             (std::exp(-_saturate_coefficient *
    ...
    const GenericReal<is_ad> & scalar)
{
  ...
  return _hardening_constant * (this->_effective_inelastic_strain_old[_qp] + scalar) +
         (_ultimate_strength - _yield_stress) *
             (1.0 - std::exp(-_saturate_coefficient *
                             (this->_effective_inelastic_strain_old[_qp] + scalar)));
}
