 ...
 * increments
 */
class ADMixtureOfExpertsElastoViscoplasticStress2 : public ADComputeStressBase
{
public:
  static InputParameters validParams();

  ADMixtureOfExpertsElastoViscoplasticStress2(const InputParameters & parameters);
