...
# Why this exists: Confirms bilinear normal traction law shape and stability under temporal and spatial refinement.
...
[AuxKernels]
  ...
  [local_tangential_jump_one]
    type = CohesiveZoneMortarUserObjectAux
    variable = local_tangential_jump_one
    user_object = czm_uo
    cohesive_zone_quantity = local_tangential_jump_one
  []
  [cohesive_traction_normal]
    type = CohesiveZoneMortarUserObjectAux
