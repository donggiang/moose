...
mpiexec -n 80 moose-dev-exec /home/huyngd/projects/moose_AD/modules/xfem/xfem-opt -i ADCCG_enriched_creep_crack.i ####--distributed-mesh  ####  --split-mesh 112 --split-file ct_h0p4 #
