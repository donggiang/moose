...
void
ADCrackTipEnrichmentStressDivergenceTensors::initialSetup()
{
...
ADCrackTipEnrichmentStressDivergenceTensors::computeQpResidual()
{
  ...
  // std::cout << "ADCrackTipEnrichmentStressDivergenceTensors::computeQpResidual()\n";
...
//   std::cout << "CrackTipEnrichmentStressDivergenceTensors::computeQpOffDiagJacobian\n";
...
//   if (active_enrich)
//   {
//     std::cout << "CrackTipEnrichmentStressDivergenceTensors::computeQpOffDiagJacobian, enrich\n";
...
//   else if (active)
//   {
//     std::cout << "CrackTipEnrichmentStressDivergenceTensors::computeQpOffDiagJacobian active\n";
