...
MeshCut2DFractureUserObject::initialize()
{
  ...
  // std::cout << "call findActiveBoundaryGrowth1\n";
  findActiveBoundaryGrowth();
  // std::cout << "call findActiveBoundaryGrowth2\n";

  growFront();
  // std::cout << "MeshCut2DFractureUserObject::initialize(), crack front provider3: "
  //           << getCrackFrontPoints(1)[0] << "\n";
