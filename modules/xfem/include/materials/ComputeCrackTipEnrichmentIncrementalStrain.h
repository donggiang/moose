...
private:
  ...
  NonlinearSystem * _nl;
  NonlinearSystemBase * _nlb;
  const NumericVector<Number> * _sln;
};

// /**
//  * ComputeCrackTipEnrichmentIncrementalStrain calculates the sum of standard strain and
//  enrichement strain
//  */
// class ComputeCrackTipEnrichmentIncrementalStrain : public ComputeStrainBase,
