 ...
 */
class ADComputeCrackTipEnrichmentSmallStrain : public ADComputeStrainBase
{
public:
  static InputParameters validParams();

  ADComputeCrackTipEnrichmentSmallStrain(const InputParameters & parameters);
  virtual ~ADComputeCrackTipEnrichmentSmallStrain() {}
